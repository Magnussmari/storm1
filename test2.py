"""
STORM Wiki pipeline powered by GPT-4o and GPT-4o Mini and You.com search engine.
...
def main(args):
    ...
    # Using GPT-4o Mini for the conversational simulator and question asking (faster, less resource-intensive tasks)
    ...
    # Using GPT-4o for the outline and article generation (more powerful tasks)
    ...
    engine_args = STORMWikiRunnerArguments(
        ...
        max_conv_turn=10,  # More conversational turns for a more detailed article
        max_perspective=10,  # Consider more perspectives
        search_top_k=10,  # Retrieve more search results
    ...
    topic = "AI and the Educational System in Iceland"
    runner.run(
        topic=topic,
